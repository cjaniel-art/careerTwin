...
**Verificado:** `npm run typecheck`, `npm run lint`, `npm run test` (62/62) e `npm run build` sem erros antes do deploy. Verificação ao vivo em produção com a chave real pendente do próximo deploy (mesmo teste de upload de currículo).
